...
def crear_interfaz(matriz):
    ...
    etiqueta1 = tk.Label(root, text="Cantidad nodos: " + str(agente["reporte"]["nodos_expandidos"]))
    etiqueta1.pack()

    etiqueta2 = tk.Label(root, text="Tiempo Computo: " + str(agente["reporte"]["tiempo_computo"]))
    etiqueta2.pack()

    etiqueta3 = tk.Label(root, text="Profundidad Árbol: " + str(agente["reporte"]["profundidad_arbol"]))
    etiqueta3.pack()
